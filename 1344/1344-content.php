                            ...
                            <div class="tab-content">
                                ...
                                <div id="d" class="tab-pane"    style="background: white;">
                                    <div class="all">
                                        ...
                                        <div>
                                            <div class="image">
                                                <img class="img-reponsive" src="<?php echo $url_path ?>/image/2.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="e" class="tab-pane">
                                    ...
                                    <div><h1 style="padding-bottom: 10px"> Top Bar</h1></div>
                                        <div>
                                            <div class="image">
                                                <img class="img-reponsive" src="<?php echo $url_path ?>/image/3.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="f" class="tab-pane">
                                    <div class="all">
                                        ...
                                        <div>
                                            <div class="image">
                                                <img class="img-reponsive" src="<?php echo $url_path ?>/image/4.jpg" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
